...
!(function(t, n) {
    ...
    function s(t, n) {
        ...
        if (null == n) {
            for (; ++a < o; )
                if (null != (e = t[a]) && e >= e) for (r = i = e; ++a < o; ) null != (e = t[a]) && (r > e && (r = e), i < e && (i = e));
    ...
    Pt.prototype = zt.prototype = {
        ...
        on: function(t, n, e) {
            var r,
                ...
                a = o.length;
            if (!(arguments.length < 2)) {
                for (u = n ? St : Tt, null == e && (e = !1), r = 0; r < a; ++r) this.each(u(o[r], n, e));
                return this;
            }
    ...
    Qt(Jt, vn, {
        ...
        Qt(
            ...
            Kt(Jt, {
                brighter: function(t) {
                    return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new mn(this.r * t, this.g * t, this.b * t, this.opacity);
                },
                darker: function(t) {
                    return (t = null == t ? 0.7 : Math.pow(0.7, t)), new mn(this.r * t, this.g * t, this.b * t, this.opacity);
                },
                rgb: function() {
                    return this;
                },
        ...
        Qt(
            ...
            Kt(Jt, {
                brighter: function(t) {
                    return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Sn(this.h, this.s, this.l * t, this.opacity);
                },
                darker: function(t) {
                    return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Sn(this.h, this.s, this.l * t, this.opacity);
                },
                rgb: function() {
    ...
    Qt(
        ...
        Kt(Jt, {
            ...
            rgb: function() {
                ...
                return new mn(
                    Hn(3.1338561 * (n = Pn * In(n)) - 1.6168667 * (t = zn * In(t)) - 0.4906146 * (e = Rn * In(e))),
    ...
    Qt(
        ...
        Kt(Jt, {
            brighter: function(t) {
                return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new ie(this.h, this.s, this.l * t, this.opacity);
            },
            darker: function(t) {
                return (t = null == t ? 0.7 : Math.pow(0.7, t)), new ie(this.h, this.s, this.l * t, this.opacity);
            },
            rgb: function() {
    ...
    function Me(t, n) {
        ...
        for (t += '', n += ''; (e = xe.exec(t)) && (r = we.exec(n)); )
            (i = r.index) > o && ((i = n.slice(o, i)), u[a] ? (u[a] += i) : (u[++a] = i)),
                (e = e[0]) === (r = r[0]) ? (u[a] ? (u[a] += r) : (u[++a] = r)) : ((u[++a] = null), c.push({ i: a, x: be(e, r) })),
                (o = we.lastIndex);
        return (
    ...
    function ze(t, n, e, r, i, o) {
        ...
        return (
            ...
            { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Ce, skewX: Math.atan(c) * Ce, scaleX: a, scaleY: u }
        );
    }
    function Re(t, n, e, r) {
        function i(t) {
    ...
    var De = Re(
            function(t) {
                return 'none' === t
                    ? Pe
                    : (Te || ((Te = document.createElement('DIV')), (Se = document.documentElement), (ke = document.defaultView)),
                      (Te.style.transform = t),
                      (t = ke.getComputedStyle(Se.appendChild(Te), null).getPropertyValue('transform')),
                      Se.removeChild(Te),
        ...
        qe = Re(
            function(t) {
                return null == t
                    ? Pe
                    : (Ee || (Ee = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
                ...
                (function() {
                    ...
                    for (; e; )
                        e._call
                            ...
                            : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Qe = n)));
                    (Ke = t), vr(r);
                })(),
                (ir = 0);
        }
    ...
    function vr(t) {
        Je ||
            ...
            t - ir > 24
                ? (t < 1 / 0 && (tr = setTimeout(dr, t - ar.now() - or)), nr && (nr = clearInterval(nr)))
                : (nr || ((rr = ar.now()), (nr = setInterval(pr, er))), (Je = 1), ur(dr)));
    }
    function gr(t, n, e) {
        var r = new sr();
        return (
    ...
    sr.prototype = lr.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            (e = (null == e ? cr() : +e) + (null == n ? 0 : +n)),
                this._next || Ke === this || (Ke ? (Ke._next = this) : (Qe = this), (Ke = this)),
                (this._call = t),
                (this._time = e),
                vr();
        },
    ...
    function Tr(t, n, e, r, i, o) {
        ...
        !(function(t, n, e) {
            ...
            function a(n) {
                for (
                    var i = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u), (e.state = Nr), 1),
                        o = -1,
                        a = r.length;
                    ++o < a;
    ...
    Lr.prototype = Ur.prototype = {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
                for (var u, c, f = r[a], s = f.length, l = (o[a] = new Array(s)), h = 0; h < s; ++h)
                    (u = f[h]) &&
                        ...
                        ('__data__' in u && (c.__data__ = u.__data__), (l[h] = c), Tr(l[h], n, e, h, l, Er(u, e)));
        ...
        tween: function(t, n) {
            ...
            if (((t += ''), arguments.length < 2)) {
                for (var r, i = Er(this.node(), e).tween, o = 0, a = i.length; o < a; ++o) if ((r = i[o]).name === t) return r.value;
                return null;
            }
            return this.each(
                (null == n
    ...
    function vi(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]); ) if (!(t = t.parentNode)) return (pi.time = cr()), pi;
        return e;
    }
    (zt.prototype.interrupt = function(t) {
        ...
        (zt.prototype.transition = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
                for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) (a = u[f]) && Tr(a, t, n, f, u, e || vi(a, n));
    ...
    var Si = {
        ...
        Di = { overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1 };
    function qi(t) {
        return { type: t };
    }
    function Li() {
    ...
    function Yi(n) {
        ...
        function d() {
                                        ...
                                        x === wi &&
                                            (t.event.altKey
                                                ? (w && ((f = h - P * w), (r = o + P * w)),
                                                  M && ((d = p - z * M), (u = c + z * M)),
                                                  (x = Ni))
                                                : (w < 0 ? (f = h) : w > 0 && (r = o), M < 0 ? (d = p) : M > 0 && (u = c), (x = Mi)),
                                            B.attr('cursor', Ci[m]),
                                            I());
                                        break;
                                    default:
            ...
            function I() {
                ...
                h < o && ((w *= -1), (t = r), (r = f), (f = t), (t = o), (o = h), (h = t), m in Pi && B.attr('cursor', Ci[(m = Pi[m])])),
                    p < c &&
                        ((M *= -1), (t = u), (u = d), (d = t), (t = c), (c = p), (p = t), m in zi && B.attr('cursor', Ci[(m = zi[m])])),
            ...
            if (null === this._x1) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = n);
                ...
                if (Math.abs(s * u - c * f) > 1e-6 && i) {
                    ...
                    Math.abs(b - 1) > 1e-6 && (this._ += 'L' + (t + b * f) + ',' + (n + b * s)),
                        (this._ +=
                            'A' + i + ',' + i + ',0,0,' + +(s * h > f * d) + ',' + (this._x1 = t + m * u) + ',' + (this._y1 = n + m * c));
    ...
    function bo(t, n) {
        for (var e, r = -1, i = n.length; ++r < i; ) if ((e = mo(t, n[r]))) return e;
        return 0;
    }
    function mo(t, n) {
        ...
        function o(e, i) {
            ...
            return (
                ...
                u.forEach(function(t) {
                    for (var n, e = 0, r = o.length; e < r; ++e) if (-1 !== bo((n = o[e])[0], t)) return void n.push(t);
                }),
    ...
    function Oo(t) {
        ...
        return isNaN(t)
            ...
            : (function(t) {
                  ...
                  Uo(t.getUTCDate(), 2) +
                  (i
                      ? 'T' + Uo(n, 2) + ':' + Uo(e, 2) + ':' + Uo(r, 2) + '.' + Uo(i, 3) + 'Z'
                      : r
    ...
    var Ua,
        ...
        Ba = ['y', 'z', 'a', 'f', 'p', 'n', 'µ', 'm', '', 'k', 'M', 'G', 'T', 'P', 'E', 'Z', 'Y'];
    function Ya(t) {
        var n,
            e,
            r =
        ...
        function l(t) {
            var n = (t = za(t)).fill,
                ...
                y = t.trim,
                _ = t.type;
            'n' === _ ? ((v = !0), (_ = 'g')) : qa[_] || (void 0 === g && (g = 12), (y = !0), (_ = 'g')),
                (d || ('0' === n && '=' === e)) && ((d = !0), (n = '0'), (e = '='));
            ...
            function M(t) {
                ...
                switch ((v && d && ((t = r(T + t, T.length ? p - M.length : 1 / 0)), (T = '')), e)) {
                    case '<':
                        t = h + t + M + T;
                        break;
                    case '=':
    ...
    Fa({ decimal: '.', thousands: ',', grouping: [3], currency: ['$', ''], minus: '-' }),
        (Ga.prototype = {
            constructor: Ga,
            reset: function() {
                this.s = this.t = 0;
    ...
    var mu = {
            ...
            FeatureCollection: function(t, n) {
                for (var e = t.features, r = -1, i = e.length; ++r < i; ) bu(e[r].geometry, n);
            },
        },
        xu = {
            Sphere: function(t, n) {
            ...
            MultiLineString: function(t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) wu(e[r], n, 0);
            },
            Polygon: function(t, n) {
                Mu(t.coordinates, n);
            },
            MultiPolygon: function(t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) Mu(e[r], n);
            },
    ...
    var Au,
        ...
        zu = {
            ...
            polygonEnd: function() {
                var t = +Cu;
                Pu.add(t < 0 ? tu + t : t), (this.lineStart = this.lineEnd = this.point = _u);
            },
            sphere: function() {
                Pu.add(tu);
            },
        ...
        yc = {
            ...
            polygonEnd: function() {
                zu.polygonEnd(),
                    ...
                    (yc.lineStart = mc),
                    (yc.lineEnd = xc),
                    Cu < 0 ? ((ju = -(Gu = 180)), (Xu = -(Vu = 90))) : gc > Wa ? (Vu = 90) : gc < -Wa && (Xu = -90),
                    (Ju[0] = ju),
                    (Ju[1] = Gu);
            },
            sphere: function() {
    ...
    function zc(t, n) {
        t *= eu;
        var e = au((n *= eu));
        (dc = e * au(t)), (pc = e * lu(t)), (vc = lu(n)), (kc.point = Rc), Cc(dc, pc, vc);
    }
    function Rc(t, n) {
        t *= eu;
        var e = au((n *= eu)),
            ...
            i = e * lu(t),
            o = lu(n),
            a = ou(du((a = pc * o - vc * i) * a + (a = vc * r - dc * o) * a + (a = dc * i - pc * r) * a), dc * r + pc * i + vc * o);
        (nc += a), (oc += a * (dc + (dc = r))), (ac += a * (pc + (pc = i))), (uc += a * (vc + (vc = o))), Cc(dc, pc, vc);
    }
    function Dc() {
        kc.point = Ec;
    }
    ...
    function Vc(t, n, e, r, i, o) {
        if (e) {
            var a = au(n),
                u = lu(n),
                c = r * e;
            null == i ? ((i = n + r * tu), (o = n - c / 2)) : ((i = $c(a, i)), (o = $c(a, o)), (r > 0 ? i < o : i > o) && (i += r * tu));
            for (var f, s = i; r > 0 ? s > o : s < o; s -= c) (f = Uu([a, -u * au(s), -u * lu(s)])), t.point(f[0], f[1]);
        }
    }
    function $c(t, n) {
        ((n = Ou(n))[0] -= t), Hu(n);
    ...
    function ef(t, n) {
        ...
        for (var c = 0, f = t.length; c < f; ++c)
            if ((l = (s = t[c]).length))
                for (
                    var s, l, h = s[l - 1], d = nf(h), p = h[1] / 2 + Ja, v = lu(p), g = au(p), y = 0;
                    y < l;
                    ++y, d = b, v = x, g = w, h = _
                ) {
                    var _ = s[y],
                        ...
                        T = A > Qa,
                        S = v * x;
                    if ((tf.add(ou(S * N * lu(A), g * w + S * au(A))), (a += T ? M + N * tu : M), T ^ (d >= e) ^ (b >= e))) {
                        var k = Yu(Ou(h), Ou(_));
                        Hu(k);
                        var E = Yu(o, k);
                        Hu(E);
                        ...
                        : i !== u &&
                          ...
                          (r = (function(t, n, e, r) {
                              var i,
                                  ...
                                  a = lu(t - e);
                              return ru(a) > Wa
                                  ? iu((lu(n) * (o = au(r)) * lu(e) - lu(r) * (i = au(n)) * lu(t)) / (i * o * a))
                                  : (n + r) / 2;
                          })(e, r, o, a)),
                          t.point(i, r),
                          t.lineEnd(),
            ...
            function(t) {
                ...
                return {
                    ...
                    point: function(l, h) {
                        ...
                        if (
                            (!n && (f = c = v) && t.lineStart(),
                            v !== c && (!(d = a(n, p)) || Zc(n, d) || Zc(p, d)) && ((p[0] += Wa), (p[1] += Wa), (v = o(p[0], p[1]))),
                            v !== c)
                        )
                            (s = 0),
                                v ? (t.lineStart(), (d = a(p, n)), t.point(d[0], d[1])) : ((d = a(n, p)), t.point(d[0], d[1]), t.lineEnd()),
                                (n = d);
                        else if (i && n && r ^ v) {
                            var y;
                            g & e ||
            ...
            function M(o, a) {
                ...
                if ((f && s.push([o, a]), y)) (l = o), (h = a), (d = u), (y = !1), u && (b.lineStart(), b.point(o, a));
                    ...
                    var c = [(p = Math.max(sf, Math.min(ff, p))), (v = Math.max(sf, Math.min(ff, v)))],
                        m = [(o = Math.max(sf, Math.min(ff, o))), (a = Math.max(sf, Math.min(ff, a)))];
    ...
    var Nf = {
            ...
            FeatureCollection: function(t, n) {
                for (var e = t.features, r = -1, i = e.length; ++r < i; ) if (Tf(e[r].geometry, n)) return !0;
                return !1;
            },
        },
        Af = {
            ...
            MultiLineString: function(t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (kf(e[r], n)) return !0;
                return !1;
            },
            Polygon: function(t, n) {
            ...
            MultiPolygon: function(t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (Ef(e[r], n)) return !0;
                return !1;
            },
            GeometryCollection: function(t, n) {
                for (var e = t.geometries, r = -1, i = e.length; ++r < i; ) if (Tf(e[r], n)) return !0;
                return !1;
            },
        };
    function Tf(t, n) {
    ...
    function kf(t, n) {
        for (var e, r, i, o = 0, a = t.length; o < a; o++) {
            ...
            if (o > 0 && (i = Mf(t[o], t[o - 1])) > 0 && e <= i && r <= i && (e + r - i) * (1 - Math.pow((e - r) / i, 2)) < Za * i)
                return !0;
            e = r;
        }
        return !1;
    ...
    var Kf,
        ...
        ls = {
            ...
            result: function() {
                var t = ss ? [cs / ss, fs / ss] : us ? [os / us, as / us] : is ? [es / is, rs / is] : [NaN, NaN];
    ...
    function vs(t, n) {
        var e = t - ts,
            r = n - ns,
            i = du(e * e + r * r);
        (os += (i * (ts + t)) / 2), (as += (i * (ns + n)) / 2), (us += i), hs((ts = t), (ns = n));
    }
    function gs() {
        ls.point = hs;
    }
            ...
            ? (function(t, n) {
                  function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                      ...
                      if (b > 4 * n && v--) {
                          var m = a + h,
                              ...
                              C = k - i,
                              P = _ * E - y * C;
                          ((P * P) / b > n || ru((y * E + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < Fs) &&
                  ...
                  return function(n) {
                      ...
                      function _(r, i) {
                          var o = Ou([r, i]),
                              a = t(r, i);
                          e(s, l, f, h, d, p, (s = a[0]), (l = a[1]), (f = r), (h = o[0]), (d = o[1]), (p = o[2]), Ys, n), n.point(s, l);
                      }
                      function b() {
                          (v.point = g), n.lineEnd();
                      }
    ...
    function Gs(t) {
        ...
        function S() {
            ...
            return (e = Ic(g, y, _)), (u = Yc(n, r)), (c = Yc(e, u)), (a = Is(u, N)), k();
        }
        function k() {
            return (f = s = null), A;
        }
        return (
            ...
            (A.clipExtent = function(t) {
                return arguments.length
                    ? ((M = null == t ? ((w = r = i = o = null), qf) : lf((w = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
                      k())
                    : null == w
                    ? null
                    : [
            ...
            (A.rotate = function(t) {
                return arguments.length
                    ? ((g = (t[0] % 360) * eu), (y = (t[1] % 360) * eu), (_ = t.length > 2 ? (t[2] % 360) * eu : 0), S())
                    : [g * nu, y * nu, _ * nu];
            }),
            (A.angle = function(t) {
    ...
    function $s(t, n) {
        ...
        return (
            (a.invert = function(t, n) {
                var e = o - n;
                return [(ou(t, ru(e)) / r) * hu(e), gu((i - (t * t + e * e) * r * r) / (2 * r))];
            }),
            a
        );
    }
    ...
    function hl(t, n) {
        var e = gu(ll * lu(n)),
            r = e * e,
            i = r * r * r;
        return [(t * au(e)) / (ll * (ul + 3 * cl * r + i * (7 * fl + 9 * sl * r))), e * (ul + cl * r + i * (fl + sl * r))];
    }
    function dl(t, n) {
        var e = au(n),
            r = au(t) * e;
    ...
    (hl.invert = function(t, n) {
        for (
            ...
            a < 12 &&
            ((o = (i = (r -= e = (r * (ul + cl * i + o * (fl + sl * i)) - n) / (ul + 3 * cl * i + o * (7 * fl + 9 * sl * i))) * r) * i * i),
            !(ru(e) < Za));
            ++a
        );
        return [(ll * t * (ul + 3 * cl * i + o * (7 * fl + 9 * sl * i))) / au(r), gu(lu(r) / ll)];
    }),
        (dl.invert = Ks(iu)),
    ...
    function Cl(t, n) {
        var e, r;
        if (Rl(n, t)) return [n];
        for (e = 0; e < t.length; ++e) if (Pl(n, t[e]) && Rl(ql(t[e], n), t)) return [t[e], n];
        for (e = 0; e < t.length - 1; ++e)
            for (r = e + 1; r < t.length; ++r)
                if (Pl(ql(t[e], t[r]), n) && Pl(ql(t[e], n), t[r]) && Pl(ql(t[r], n), t[e]) && Rl(Ll(t[e], t[r], n), t))
                    return [t[e], t[r], n];
        throw new Error();
    }
    function Pl(t, n) {
    ...
    function Fl(t) {
        ...
        Ul(e, n, (r = t[2])),
            ...
            (r.next = e.previous = n);
        t: for (u = 3; u < i; ++u) {
            Ul(n._, e._, (r = t[u])), (r = new Yl(r)), (c = e.next), (f = n.previous), (s = e._.r), (l = n._.r);
            do {
                if (s <= l) {
                    if (Ol(c._, r._)) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Bl(n); (r = r.next) !== e; )
                (a = Bl(r)) < o && ((n = r), (o = a));
            e = n.next;
        }
    ...
    function lh(t, n, e, r, i, o) {
        for (var a, u, c, f, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
            ...
            y.push((a = { value: s, dice: c < f, children: _.slice(b, m) })),
                a.dice ? Ql(a, e, r, i, w ? (r += (f * s) / w) : o) : fh(a, e, r, w ? (e += (c * s) / w) : i, o),
                (w -= s),
                (b = m);
        }
        return y;
        ...
        function e(t, e, r, i, o) {
            if ((a = t._squarify) && a.ratio === n)
                for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
                    ...
                    u.dice ? Ql(u, e, r, i, (r += ((o - r) * u.value) / d)) : fh(u, e, r, (e += ((i - e) * u.value) / d), o),
                        (d -= u.value);
                }
    ...
    function Ih(n, e, r, i) {
        ...
        switch ((i = za(null == i ? ',f' : i)).type) {
            case 's':
                ...
                return null != i.precision || isNaN((o = Ha(a, u))) || (i.precision = o), t.formatPrefix(i, u);
            case '':
            case 'e':
            case 'g':
            case 'p':
            case 'r':
                null != i.precision || isNaN((o = ja(a, Math.max(Math.abs(n), Math.abs(e))))) || (i.precision = o - ('e' === i.type));
                break;
            case 'f':
            case '%':
                null != i.precision || isNaN((o = Ia(a))) || (i.precision = o - 2 * ('%' === i.type));
        }
        return t.format(i);
    }
    function Hh(t) {
    ...
    function pp(t) {
        ...
        function w(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f; )
                    37 === t.charCodeAt(u) &&
                        (a.push(t.slice(c, u)),
                        null != (i = gp[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = 'e' === r ? ' ' : '0'),
                        (o = n[r]) && (r = o(e, i)),
                        a.push(r),
                        (c = u + 1));
        ...
        function M(t, n) {
            return function(e) {
                ...
                return 'Z' in o ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), hp(o)) : n(o);
            };
        }
        function N(t, n, e, r) {
    ...
    function tv(t, n) {
        var e = t.getDay();
        return (t = e >= 4 || 0 === e ? Td(t) : Td.ceil(t)), mp(Td.count(Od(t), t) + (4 === Od(t).getDay()), n, 2);
    }
    function nv(t) {
        return t.getDay();
    }
    ...
    function ov(t) {
        ...
        return (n > 0 ? '-' : ((n *= -1), '+')) + mp((n / 60) | 0, '0', 2) + mp(n % 60, '0', 2);
    }
    function av(t, n) {
    ...
    function yv(t, n) {
        var e = t.getUTCDay();
        return (t = e >= 4 || 0 === e ? Qd(t) : Qd.ceil(t)), mp(Qd.count(fp(t), t) + (4 === fp(t).getUTCDay()), n, 2);
    }
    function _v(t) {
        return t.getUTCDay();
    }
    ...
    function Tv(n) {
        return (
            (vp = pp(n)), (t.timeFormat = vp.format), (t.timeParse = vp.parse), (t.utcFormat = vp.utcFormat), (t.utcParse = vp.utcParse), vp
        );
    }
    Tv({
        dateTime: '%x, %X',
    ...
    var n_ = {
        ...
        h_ = {
            draw: function(t, n) {
                ...
                t.moveTo(0, 2 * e), t.lineTo(-l_ * e, -e), t.lineTo(l_ * e, -e), t.closePath();
            },
        },
        d_ = Math.sqrt(3) / 2,
        p_ = 1 / Math.sqrt(12),
    ...
    function F_(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            a = (e - t._y1) / (i || (r < 0 && -0)),
            u = (o * i + a * r) / (r + i);
        return (Y_(o) + Y_(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
    }
    function I_(t, n) {
        var e = t._x1 - t._x0;
            ...
            if (((o = r - c), h || !(o < 0))) {
                ...
                if (((o = e - f), d || !(o > 0))) {
                    ...
                    if (((o = i - f), d || !(o < 0))) {
                        ...
                        return (
                            !(s > 0 || l < 1) || (s > 0 && (t[0] = [c + s * h, f + s * d]), l < 1 && (t[1] = [c + l * h, f + l * d]), !0)
                        );
                    }
                }
            }
        ...
        (ab.prototype = {
            ...
            insert: function(t, n) {
                ...
                if (t) {
                    ...
                    this._
                        ? ((t = sb(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
                        : ((n.P = n.N = null), (this._ = n), (e = null));
                for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
                    e === (r = e.U).L
                        ? (i = r.R) && i.C
                            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                            : (t === e.R && (cb(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), fb(this, r))
                        : (i = r.L) && i.C
                        ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                        : (t === e.L && (fb(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), cb(this, r)),
                        (e = t.U);
                this._.C = !1;
            },
            remove: function(t) {
                ...
                if (
                    ...
                    o && a
                        ? ((r = e.C),
                          ...
                          (e.L = o),
                          (o.U = e),
                          e !== a ? ((i = e.U), (e.U = t.U), (t = e.R), (i.L = t), (e.R = a), (a.U = e)) : ((e.U = i), (i = e), (t = e.R)))
                        : ((r = t.C), (t = e)),
                    t && (t.U = i),
                    !r)
                )
                        ...
                        do {
                            ...
                            if (t === i.L) {
                                if (((n = i.R).C && ((n.C = !1), (i.C = !0), cb(this, i), (n = i.R)), (n.L && n.L.C) || (n.R && n.R.C))) {
                                    (n.R && n.R.C) || ((n.L.C = !1), (n.C = !0), fb(this, n), (n = i.R)),
                                        (n.C = i.C),
                                        (i.C = n.R.C = !1),
                                        cb(this, i),
                                        (t = this._);
                                ...
                                ((n = i.L).C && ((n.C = !1), (i.C = !0), fb(this, i), (n = i.L)), (n.L && n.L.C) || (n.R && n.R.C))
                            ) {
                                (n.L && n.L.C) || ((n.R.C = !1), (n.C = !0), cb(this, n), (n = i.L)),
                                    (n.C = i.C),
                                    (i.C = n.L.C = !1),
                                    fb(this, i),
                                    (t = this._);
    ...
    function Mb(t) {
        var n = t.circle;
        n && (n.P || (bb = n.N), Db.remove(n), mb.push(n), ub(n), (t.circle = null));
    }
    var Nb = [];
    function Ab() {
    ...
    function kb(t) {
        var n = t.circle,
            ...
            u = [t];
        Sb(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < Lb && Math.abs(r - c.circle.cy) < Lb; )
            (o = c.P), u.unshift(c), Sb(c), (c = o);
        u.unshift(c), Mb(c);
        for (var f = a; f.circle && Math.abs(e - f.circle.x) < Lb && Math.abs(r - f.circle.cy) < Lb; ) (a = f.N), u.push(f), Sb(f), (f = a);
        u.push(f), Mb(f);
        var s,
            l = u.length;
        for (s = 1; s < l; ++s) (f = u[s]), (c = u[s - 1]), db(f.edge, c.site, f.site, i);
    ...
    function Eb(t) {
        for (var n, e, r, i, o = t[0], a = t[1], u = zb._; u; )
            if ((r = Cb(u, a) - o) > Lb) u = u.L;
                ...
                if (!((i = o - Pb(u, a)) > Lb)) {
                    r > -Lb ? ((n = u.P), (e = u)) : i > -Lb ? ((n = u), (e = u.N)) : (n = e = u);
                    break;
                }
                if (!u.R) {
                    n = u;
        ...
        if ((zb.insert(n, c), n || e)) {
            if (n === e) return Mb(n), (e = Tb(n.site)), zb.insert(c, e), (c.edge = e.edge = lb(n.site, c.site)), wb(n), void wb(e);
            if (e) {
                Mb(n), Mb(e);
                var f = n.site,
                    s = f[0],
                ...
                db(e.edge, f, p, m), (c.edge = lb(f, t, null, m)), (e.edge = lb(t, p, null, m)), wb(n), wb(e);
    ...
    function Yb(t, n) {
        ...
        for (qb = [], Rb = new Array(t.length), zb = new ab(), Db = new ab(); ; )
            if (((i = bb), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
                (o[0] === e && o[1] === r) || (Eb(o), (e = o[0]), (r = o[1])), (o = t.pop());
            else {
                if (!i) break;
                kb(i.arc);
            }
        if (
            ...
            !(function(t, n, e, r) {
                for (var i, o = qb.length; o--; )
                    (vb((i = qb[o]), t, n, e, r) &&
                        pb(i, t, n, e, r) &&
                        (Math.abs(i[0][0] - i[1][0]) > Lb || Math.abs(i[0][1] - i[1][1]) > Lb)) ||
                        delete qb[o];
            })(a, u, c, f),
                (function(t, n, e, r) {
                    var i,
                    ...
                    for (i = 0; i < g; ++i)
                        if ((o = Rb[i])) {
                            for (a = o.site, u = (c = o.halfedges).length; u--; ) qb[c[u]] || c.splice(u, 1);
                    ...
                    for (i = 0; i < g; ++i) (o = Rb[i]) && (o.halfedges.length || delete Rb[i]);
                })(a, u, c, f);
        }
                    ...
                    if ((o = (i = e.halfedges).length))
                        for (var i, o, a, u = e.site, c = -1, f = n[i[o - 1]], s = f.left === u ? f.right : f.left; ++c < o; )
                            (a = s),
                                ...
                                a && s && r < a.index && r < s.index && Ob(u, a, s) < 0 && t.push([u.data, a.data, s.data]);
                }),
                t
            );
        },
    ...
    (Xb.prototype = Hb.prototype),
        ...
        (t.active = function(t, n) {
            var e,
                ...
                i = t.__transition;
            if (i)
                for (r in ((n = null == n ? null : n + ''), i)) if ((e = i[r]).state > mr && e.name === n) return new Lr([[t]], gi, n, +r);
            return null;
        }),
        (t.arc = function() {
            var t = Sy,
                ...
                if ((u || (u = c = to()), l < s && ((f = l), (l = s), (s = f)), l > wy))
                    if (p > Ay - wy)
                        u.moveTo(l * yy(h), l * my(h)),
                            u.arc(0, 0, l, h, d, !v),
                            s > wy && (u.moveTo(s * yy(d), s * my(d)), u.arc(0, 0, s, d, h, v));
                    else {
                        var g,
                            y,
                            _ = h,
                        ...
                        if (A > wy) {
                            var E = Ty((A / s) * my(N)),
                                C = Ty((A / l) * my(N));
                            (w -= 2 * E) > wy ? ((m += E *= v ? 1 : -1), (x -= E)) : ((w = 0), (m = x = (h + d) / 2)),
                                (M -= 2 * C) > wy ? ((_ += C *= v ? 1 : -1), (b -= C)) : ((M = 0), (_ = b = (h + d) / 2));
                        }
                        var P = l * yy(_),
                            z = l * my(_),
                            R = s * yy(x),
                            ...
                            if (
                                ...
                                (q = (function(t, n, e, r, i, o, a, u) {
                                    var c = e - t,
                                        ...
                                        l = u - o,
                                        h = l * c - s * f;
                                    if (!(h * h < wy)) return [t + (h = (s * (n - o) - l * (t - i)) / h) * c, n + h * f];
                                })(P, z, O, B, L, U, R, D))
                            ) {
                                var Y = P - q[0],
                                    F = z - q[1],
                        ...
                        M > wy
                            ? k > wy
                                ? ((g = zy(O, B, P, z, l, k, v)),
                                  ...
                                  k < T
                                      ? u.arc(g.cx, g.cy, k, gy(g.y01, g.x01), gy(y.y01, y.x01), !v)
                                      : (u.arc(g.cx, g.cy, k, gy(g.y01, g.x01), gy(g.y11, g.x11), !v),
                                        u.arc(0, 0, l, gy(g.cy + g.y11, g.cx + g.x11), gy(y.cy + y.y11, y.cx + y.x11), !v),
                                        u.arc(y.cx, y.cy, k, gy(y.y11, y.x11), gy(y.y01, y.x01), !v)))
                            ...
                            s > wy && w > wy
                                ? S > wy
                                    ? ((g = zy(R, D, L, U, s, -S, v)),
                                      ...
                                      S < T
                                          ? u.arc(g.cx, g.cy, S, gy(g.y01, g.x01), gy(y.y01, y.x01), !v)
                                          : (u.arc(g.cx, g.cy, S, gy(g.y01, g.x01), gy(g.y11, g.x11), !v),
                                            u.arc(0, 0, s, gy(g.cy + g.y11, g.cx + g.x11), gy(y.cy + y.y11, y.cx + y.x11), v),
                                            u.arc(y.cx, y.cy, S, gy(y.y11, y.x11), gy(y.y01, y.x01), !v)))
                                    : u.arc(0, 0, s, x, m, v)
                                : u.lineTo(R, D);
                    }
                else u.moveTo(0, 0);
            ...
            return (
                (c.centroid = function() {
                    var e = (+t.apply(this, arguments) + +n.apply(this, arguments)) / 2,
                        r = (+i.apply(this, arguments) + +o.apply(this, arguments)) / 2 - My / 2;
        ...
        (t.contourDensity = function() {
            ...
            function l(r) {
                ...
                r.forEach(function(r, o, s) {
                    ...
                    To({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
                    Ao({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    To({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
                    Ao({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
                    To({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a);
        ...
        (t.drag = function() {
            ...
            function m(n, e, r, i, o) {
                var a,
                    ...
                    v = s.copy();
                if (
                    kt(new Gt(d, 'beforestart', a, n, l, p[0], p[1], 0, 0, v), function() {
        ...
        (t.forceManyBody = function() {
            ...
            function l(t, i, c, f) {
                ...
                if (!(t.length || d >= a)) {
                    (t.data !== n || t.next) &&
                        (0 === s && (d += (s = la()) * s), 0 === l && (d += (l = la()) * l), d < o && (d = Math.sqrt(o * d)));
                    do {
        ...
        (t.geoBounds = function(t) {
            var n, e, r, i, o, a, u;
            if (((Vu = Gu = -(ju = Xu = 1 / 0)), (Ku = []), Nu(t, yc), (e = Ku.length))) {
                for (Ku.sort(Tc), n = 1, o = [(r = Ku[0])]; n < e; ++n)
                    Sc(r, (i = Ku[n])[0]) || Sc(r, i[1])
                        ? (Ac(r[0], i[1]) > Ac(r[0], r[1]) && (r[1] = i[1]), Ac(i[0], r[1]) > Ac(r[0], r[1]) && (r[0] = i[0]))
                        : o.push((r = i));
        ...
        (t.geoCentroid = function(t) {
            ...
            var n = cc,
                ...
                r = sc,
                i = n * n + e * e + r * r;
            return i < Za && ((n = oc), (e = ac), (r = uc), nc < Wa && ((n = ec), (e = rc), (r = ic)), (i = n * n + e * e + r * r) < Za)
                ? [NaN, NaN]
                ...
                clipExtent: function(r) {
                    return arguments.length
                        ? ((d =
                              null == r
                                  ? ((h = t = n = e = null), qf)
                                  : lf((h = +r[0][0]), (t = +r[0][1]), (n = +r[1][0]), (e = +r[1][1]))),
                          p())
                        : null == h
                        ? null
                        : [
        ...
        (t.geoPath = function(t, n) {
            ...
            return (
                ...
                (o.context = function(t) {
                    return arguments.length
                        ? ((r = null == t ? ((n = null), new Ps()) : new xs((n = t))), 'function' != typeof i && r.pointRadius(i), o)
                        : n;
                }),
        ...
        (t.interpolateCividis = function(t) {
            return (
                ...
                'rgb(' +
                    ...
                    Math.max(
                        0,
                        Math.min(255, Math.round(81.24 + t * (442.36 - t * (2482.43 - t * (6167.24 - t * (6614.94 - 2475.67 * t)))))),
                    ) +
                    ')'
            );
        }),
        ...
        (t.interpolateRainbow = function(t) {
            ...
            return (oy.h = 360 * t - 100), (oy.s = 1.5 - 1.5 * n), (oy.l = 0.8 - 0.9 * n), oy + '';
        }),
        ...
        (t.interpolateTurbo = function(t) {
            return (
                ...
                'rgb(' +
                    Math.max(
                        0,
                        Math.min(255, Math.round(34.61 + t * (1172.33 - t * (10793.56 - t * (33300.12 - t * (38394.49 - 14825.05 * t)))))),
                    ) +
                    ', ' +
                    Math.max(
                        0,
            ...
            function i(i) {
                ...
                return (
                    ...
                    i.eachBefore(
                        (function(t, n) {
                            return function(r) {
                                r.children && Ql(r, r.x0, (t * (r.depth + 1)) / n, r.x1, (t * (r.depth + 2)) / n);
                                var i = r.x0,
                                    o = r.y0,
                                    a = r.x1 - e,
                                    u = r.y1 - e;
        ...
        (t.ribbon = function() {
            ...
            function a() {
                ...
                if (
                    ...
                    o.moveTo(d, p),
                    o.arc(0, 0, s, l, h),
                    (l === g && h === y) || (o.quadraticCurveTo(0, 0, v * Fi(g), v * Ii(g)), o.arc(0, 0, v, g, y)),
        ...
        (t.stratify = function() {
            ...
            function e(e) {
                ...
                for (i = 0; i < s; ++i)
                    (r = e[i]),
                        (u = l[i] = new Sl(r)),
                        null != (c = t(r, i, e)) && (c += '') && (h[(f = Kl + (u.id = c))] = f in h ? th : u);
                for (i = 0; i < s; ++i)
        ...
        (t.symbol = function() {
            ...
            function r() {
                var r;
                if ((e || (e = r = to()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r))
                ...
                n.parent.A = (function(n, e, r) {
                    if (e) {
                        for (
                            ...
                            (c = ih(c)),
                                ((a = oh(a)).a = n),
                                (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (ah(uh(u, n, r), n, i), (f += i), (s += i)),
                                (l += u.m),
                                (f += o.m),
                                (h += c.m),
                                (s += a.m);
        ...
        (t.voronoi = function() {
            ...
            function r(r) {
                return new Yb(
                    r.map(function(e, i) {
                        var o = [Math.round(t(e, i, r) / Lb) * Lb, Math.round(n(e, i, r) / Lb) * Lb];
            ...
            function N() {
                if (!e && r.apply(this, arguments)) {
                    var n = x(this, arguments, !0),
                        ...
                        u = t.event.clientX,
                        c = t.event.clientY;
                    Ht(t.event.view), Gb(), (n.mouse = [a, this.__zoom.invert(a)]), Cr(this), n.start();
                }
            }
            function A() {
                if (r.apply(this, arguments)) {
