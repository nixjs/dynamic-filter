    ...
    (h.prototype = {
        ...
        remove: function() {
            this.$cache.cont.remove(),
                ...
                e &&
                    (this.$cache.body.off('mouseup.irs_' + this.plugin_count), this.$cache.body.off('mouseleave.irs_' + this.plugin_count)),
        ...
        appendGrid: function() {
            if (this.options.grid) {
                ...
                for (
                    ...
                    for (
                        o = l, 100 < (c = this.toFixed(s * t)) && (c = 100), e = ((this.coords.big[t] = c) - s * (t - 1)) / (o + 1), i = 1;
                        i <= o && 0 !== c;
                        i++
                    )
