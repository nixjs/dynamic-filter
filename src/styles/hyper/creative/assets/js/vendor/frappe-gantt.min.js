var Gantt = (function() {
    ...
    var e = {
        parse(t, e = '-', s = /[.:]/) {
            ...
            if ('string' == typeof t) {
                ...
                let o = i;
                return (
                    n && n.length && (4 == n.length && ((n[3] = '0.' + n[3]), (n[3] = 1e3 * parseFloat(n[3]))), (o = o.concat(n))),
                    new Date(...o)
                );
            }
        },
    ...
    function s(t, e, s) {
        return (
            ...
            (e >>= 0),
            (s = String(void 0 !== s ? s : ' ')),
            t.length > e ? String(t) : ((e -= t.length) > s.length && (s += s.repeat(e / s.length)), s.slice(0, e) + String(t))
        );
    }
    function i(t, e) {
    ...
    class o {
        ...
        show_popup() {
            ...
            const t = e.format(this.task._start, 'MMM D') + ' - ' + e.format(e.add(this.task._end, -1, 'second'), 'MMM D');
        ...
        get_snap_position(t) {
            ...
            return (s = this.gantt.view_is('Week')
                ? i -
                  ...
                  (e < this.gantt.options.column_width / 14 ? 0 : this.gantt.options.column_width / 7)
                : this.gantt.view_is('Month')
                ? i -
                  (e = t % (this.gantt.options.column_width / 30)) +
                  (e < this.gantt.options.column_width / 60 ? 0 : this.gantt.options.column_width / 30)
                : i -
                  (e = t % this.gantt.options.column_width) +
                  (e < this.gantt.options.column_width / 2 ? 0 : this.gantt.options.column_width));
        }
        update_attr(t, e, s) {
        ...
        update_handle_position() {
            const t = this.$bar;
            this.handle_group.querySelector('.handle.left').setAttribute('x', t.getX() + 1),
    ...
    class r {
        ...
        calculate_path() {
            ...
            const e = () =>
                this.to_task.$bar.getX() < t + this.gantt.options.padding && t > this.from_task.$bar.getX() + this.gantt.options.padding;
            for (; e(); ) t -= 10;
            const s =
                    this.gantt.options.header_height +
    ...
    return class {
        ...
        update_view_scale(t) {
            (this.options.view_mode = t),
                'Day' === t
                    ...
                    : 'Year' === t && ((this.options.step = 8760), (this.options.column_width = 120));
        }
        setup_dates() {
        ...
        make_grid_background() {
            ...
            n('rect', { x: 0, y: 0, width: t, height: e, class: 'grid-background', append_to: this.layers.grid }),
                i.attr(this.$svg, { height: e + this.options.padding + 100, width: '100%' });
        }
        make_grid_rows() {
        ...
        make_grid_ticks() {
            ...
            for (let a of this.dates) {
                let o = 'tick';
                this.view_is('Day') && 1 === a.getDate() && (o += ' thick'),
                    this.view_is('Week') && a.getDate() >= 1 && a.getDate() < 8 && (o += ' thick'),
                    this.view_is('Month') && (a.getMonth() + 1) % 3 == 0 && (o += ' thick'),
        ...
        make_dates() {
            for (let t of this.get_dates_to_draw())
                if (
                    (n('text', { x: t.lower_x, y: t.lower_y, innerHTML: t.lower_text, class: 'lower-text', append_to: this.layers.date }),
                    t.upper_text)
                ) {
                    const e = n('text', {
                        x: t.upper_x,
        ...
        set_scroll_position() {
            ...
            if (!t) return;
            const s =
                (e.diff(this.get_oldest_starting_date(), this.gantt_start, 'hour') / this.options.step) * this.options.column_width -
        ...
        bind_bar_progress() {
            ...
            i.on(this.$svg, 'mousedown', '.handle.progress', (r, h) => {
                ...
                i.on(this.$svg, 'mousemove', e => {
                    if (!s) return;
                    let o = e.offsetX - t;
                    e.offsetY, o > a.max_dx && (o = a.max_dx), o < a.min_dx && (o = a.min_dx);
