        ...
        function(t, e, n) {
            ...
            function d(t, e) {
                var n,
                    r = t.add(e);
                return (
                    r.css({ position: 'relative', left: -1 }), (n = t.outerHeight() - e.outerHeight()), r.css({ position: '', left: '' }), n
                );
            }
            function c(t) {
            ...
            function _(t) {
                var e,
                    ...
                    i = [];
                for (
                    'string' == typeof t ? (i = t.split(/\s*,\s*/)) : 'function' == typeof t ? (i = [t]) : ht.isArray(t) && (i = t), e = 0;
                    e < i.length;
                    e++
                )
                    (n = i[e]),
            ...
            function G(t, e, n) {
                ...
                return U(n)
                    ? (e - t) / n
                    : ((r = n.asMonths()), Math.abs(r) >= 1 && ut(r) ? e.diff(t, 'months', !0) / r : e.diff(t, 'days', !0) / n.asDays());
            }
            function N(t, e) {
                var n, r;
                return U(t) || U(e)
        ...
        function(t, e, n) {
            ...
            (e.default = h),
                ...
                (d.stripZone = function() {
                    var t;
                    return (
                        this._ambigZone || ((t = this._ambigTime), this.utc(!0), (this._ambigTime = t || !1), (this._ambigZone = !0)), this
                    );
                }),
                (d.hasZone = function() {
                ...
                l = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.isEventDefStartEditable = function(t) {
                            ...
                            return (
                                null == e && null == (e = this.opt('eventStartEditable')) && (e = this.isEventDefGenerallyEditable(t)), e
                            );
                        }),
                        ...
                        (e.prototype.isEventDefResizable = function(t) {
                            ...
                            return (
                                null == e && null == (e = this.opt('eventDurationEditable')) && (e = this.isEventDefGenerallyEditable(t)), e
                            );
                        }),
                ...
                u = (function(t) {
                    ...
                    return (
                        ...
                        (e.parse = function(t, e) {
                            var n;
                            return (
                                i.isArray(t.events) ? (n = t) : i.isArray(t) && (n = { events: t }), !!n && a.default.parse.call(this, n, e)
                            );
                        }),
                ...
                o = (function() {
                    ...
                    return (
                        ...
                        (t.prototype.queryBoundingRect = function() {
                            var t;
                            return this.els.length > 0 && ((t = i.getScrollParent(this.els.eq(0))), !t.is(document) && !t.is('html,body'))
                                ? i.getClientRect(t)
                                : null;
                        }),
                ...
                f = (function() {
                    ...
                    return (
                        (t.prototype.requestEvents = function(t, e, n, r) {
                            return (
                                (!r && this.currentPeriod && this.currentPeriod.isWithinRange(t, e) && n === this.currentPeriod.timezone) ||
            ...
            var r = n(2),
                ...
                c = (function(t) {
                    function e(e, n) {
                        var r = t.call(this, e, n) || this;
                        return (
                            (r.segSelector = '.fc-list-item'), (r.scroller = new l.default({ overflowX: 'hidden', overflowY: 'auto' })), r
                        );
                    }
                    return (
                        r.__extends(e, t),
                                            ...
                                            'title' === s
                                                ...
                                                : ((l = d[s])
                                                  ...
                                                  g &&
                                                      ...
                                                      (w = r(
                                                          '<button type="button" class="' + b.join(' ') + '"' + D + '>' + m + '</button>',
                                                      )
                                                          .click(function(t) {
