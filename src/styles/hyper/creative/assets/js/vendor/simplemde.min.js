                    ...
                    (function(t) {
                        ...
                        (n.Buffer = a),
                            ...
                            (a.prototype.indexOf = function(e, t, n) {
                                ...
                                if (
                                    (0 > t && (t = Math.max(this.length + t, 0)), 'string' == typeof e && (e = a.from(e, n)), a.isBuffer(e))
                                )
                        ...
                        (a.prototype.slice = function(e, t) {
                            ...
                            (a.prototype.readUInt32LE = function(e, t) {
                                return (
                                    t || R(e, 4, this.length), (this[e] | (this[e + 1] << 8) | (this[e + 2] << 16)) + 16777216 * this[e + 3]
                                );
                            }),
                            (a.prototype.readUInt32BE = function(e, t) {
                                return (
                                    t || R(e, 4, this.length), 16777216 * this[e] + ((this[e + 1] << 16) | (this[e + 2] << 8) | this[e + 3])
                                );
                            }),
                ...
                function(t, n, r) {
                    !(function(i) {
                        ...
                        function a(e) {
                            ...
                            for (
                                c(t, s.from) < 0 && (s.to.line - t.line < l ? (a.shift().clear(), r(e, t, s.to, 0)) : r(e, t, s.from, 0));
                                c(n, u.to) < 0;
                    ...
                    !(function(t) {
                        ...
                        function w(e) {
                            ...
                            if (t.alignWidgets || (t.gutters.firstChild && e.options.fixedGutter)) {
                                for (
                                    var r = C(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + 'px', a = 0;
                                    a < n.length;
                                    a++
                                )
                                    if (!n[a].hidden) {
                        ...
                        function rt(e, t, n, r) {
                            ...
                            for (
                                var d = i.top - t.rect.top, p = i.bottom - t.rect.top, m = (d + p) / 2, g = t.view.measure.heights, u = 0;
                                u < g.length - 1 && !(m < g[u]);
                                u++
                            );
                            var v = u ? g[u - 1] : 0,
                                ...
                                for (var l = 0; l < a.length; ++l) {
                                    ...
                                    if (s.marker.collapsed) {
                                        ...
                                        if (
                                            !((u >= 0 && 0 >= f) || (0 >= u && f >= 0)) &&
                                            ((0 >= u &&
                                                (s.marker.inclusiveRight && i.inclusiveLeft ? _o(c.to, n) >= 0 : _o(c.to, n) > 0)) ||
                                                (u >= 0 &&
                        ...
                        (Ca.prototype = Hi(Vr.prototype, {
                            ...
                            setValue: It(function(e) {
                                ...
                                Tn(
                                    this,
                                    { from: t, to: Bo(n, Zr(this, n).text.length), text: this.splitLines(e), origin: 'setValue', full: !0 },
                                    !0,
                                ),
                                    Te(this, de(t));
                            }),
                                        ...
                                        for (var r = 0; r < e.formatting.length; r++)
                                            t.push(S.formatting + '-' + e.formatting[r]),
                                                'header' === e.formatting[r] &&
                                                    t.push(S.formatting + '-' + e.formatting[r] + '-' + e.header),
                                ...
                                function p(t, r) {
                                    ...
                                    if (n.strikethrough)
                                        if ('~' === s && t.eatWhile(s)) {
                                            ...
                                            if (t.match(/^[^\s]/, !1))
                                                return (
                                                    (r.strikethrough = !0), n.highlightFormatting && (r.formatting = 'strikethrough'), h(r)
                                                );
                                        } else if (' ' === s && t.match(/^~~/, !0)) {
                                            if (' ' === t.peek()) return h(r);
                                            t.backUp(2);
                                    ...
                                    if ('PFX' == l || 'SFX' == l) {
                                        for (var s = a[1], c = a[2], u = parseInt(a[3], 10), f = [], h = r + 1, d = r + 1 + u; d > h; h++) {
                                            ...
                                            (b.add = v),
                                                ...
                                                '.' !== x &&
                                                    ('SFX' === l ? (b.match = new RegExp(x + '$')) : (b.match = new RegExp('^' + x))),
