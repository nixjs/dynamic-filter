$(document).ready(function() {
    ...
    $('#products-datatable').DataTable({
        language: {
            ...
            lengthMenu:
                'Display <select class=\'custom-select custom-select-sm ml-1 mr-1\'><option value="10">10</option><option value="20">20</option><option value="-1">All</option></select> sellers',
        },
        pageLength: 10,
        columns: [
            {
