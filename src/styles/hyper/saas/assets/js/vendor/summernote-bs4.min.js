    ...
    return (function(t) {
        ...
        3: function(t, e, o) {
            ...
            var ut = {
                ...
                fromOffsetPath: function(t, e) {
                    ...
                    for (let t = 0, i = e.length; t < i; t++)
                        o = o.childNodes.length <= e[t] ? o.childNodes[o.childNodes.length - 1] : o.childNodes[e[t]];
                    return o;
                },
                splitTree: at,
            ...
            class pt {
                constructor(t, e) {
                    (this.$note = t),
                        ...
                        (n.a.summernote.ui = n.a.summernote.ui_template(this.options)),
                ...
                initializeModule(t) {
                    ...
                    (e.shouldInitialize = e.shouldInitialize || b.ok),
                        e.shouldInitialize() && (e.initialize && e.initialize(), e.events && ut.attachEvents(this.$note, e.events));
                }
                module(t, e, o) {
                ...
                removeModule(t) {
                    const e = this.modules[t];
                    e.shouldInitialize() && (e.events && ut.detachEvents(this.$note, e.events), e.destroy && e.destroy()),
            ...
            n.a.fn.extend({
                summernote: function() {
                    ...
                    (i.langInfo = n.a.extend(!0, {}, n.a.summernote.lang['en-US'], n.a.summernote.lang[i.lang])),
                        (i.icons = n.a.extend(!0, {}, n.a.summernote.options.icons, i.icons)),
            ...
            class gt {
                ...
                nativeRange() {
                    if (f.isW3CRangeSupport) {
                        ...
                        return (
                            t.setStart(this.sc, this.sc.data && this.so > this.sc.data.length ? 0 : this.so),
                    ...
                    const t = function(t, e) {
                            ...
                            if (
                                ...
                                (!ut.isEdgePoint(t) ||
                                    ...
                                    (ut.isRightEdgePoint(t) && e && ut.isVoid(t.node.nextSibling)) ||
                                    (ut.isLeftEdgePoint(t) && !e && ut.isVoid(t.node.previousSibling)) ||
                            ...
                            return (
                                (e
                                    ? ut.nextPointUntil(ut.nextPoint(t), ut.isVisiblePoint)
                                    : ut.prevPointUntil(ut.prevPoint(t), ut.isVisiblePoint)) || t
                            );
                        },
                            ...
                            function(e) {
                                ...
                                i
                                    ? (ut.isLeftEdgePoint(e) && a.push(e.node),
                                      ut.isRightEdgePoint(e) && y.contains(a, e.node) && (n = e.node))
                ...
                splitText() {
                    const t = this.sc === this.ec,
                        e = this.getPoints();
                    return (
                        ut.isText(this.ec) && !ut.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
                        ut.isText(this.sc) &&
                            !ut.isEdgePoint(this.getStartPoint()) &&
                            ((e.sc = this.sc.splitText(this.so)), (e.so = 0), t && ((e.ec = e.sc), (e.eo = this.eo - this.so))),
                ...
                wrapBodyInlineWithPara() {
                    if (ut.isBodyContainer(this.sc) && ut.isEmpty(this.sc))
                        return (this.sc.innerHTML = ut.emptyPara), new gt(this.sc.firstChild, 0, this.sc.firstChild, 0);
            ...
            var bt = {
                    ...
                    if (2 === arguments.length) return new gt(t, e, (o = t), (i = e));
                    {
                        ...
                        if (!t && 1 === arguments.length) {
                            ...
                            return (
                                ...
                                this.createFromBodyElement(t, ut.emptyPara === arguments[0].innerHTML)
                            );
                        }
                        return t;
                    }
                ...
                createFromNode: function(t) {
                    let e = t,
                        ...
                        n = ut.nodeLength(i);
                    return (
                        ut.isVoid(e) && ((o = ut.listPrev(e).length - 1), (e = e.parentNode)),
                        ut.isBR(i)
                            ? ((n = ut.listPrev(i).length - 1), (i = i.parentNode))
                            : ut.isVoid(i) && ((n = ut.listPrev(i).length), (i = i.parentNode)),
                        this.create(e, o, i, n)
                    );
                },
            ...
            class Ct {
                ...
                makeSnapshot() {
                    ...
                    return {
                        ...
                        bookmark:
                            t && t.isOnEditable() ? t.bookmark(this.editable) : { s: { path: [], offset: 0 }, e: { path: [], offset: 0 } },
                    };
                }
                applySnapshot(t) {
                    null !== t.contents && this.$editable.html(t.contents),
                        null !== t.bookmark && bt.createFromBookmark(this.editable, t.bookmark).select();
                }
                rewind() {
            ...
            class wt {
                ...
                current(t) {
                    ...
                    return (
                        (o.anchor = t.isOnAnchor() && ut.ancestor(t.sc, ut.isAnchor)),
            ...
            class yt {
                    ...
                    n.a.each(i, (t, e) => {
                        ...
                        if (ut.isLi(o)) {
                            ...
                            t
                                ...
                                : (this.wrapList(e, o.parentNode.nodeName), e.map(t => t.parentNode).map(t => this.appendToPrevious(t)));
                        } else
                            n.a.each(e, (t, e) => {
                ...
                wrapList(t, e) {
                    ...
                    return (
                        (t = t.map(t => (ut.isPurePara(t) ? ut.replace(t, 'LI') : t))),
                        ut.appendChildNodes(r, t),
                        s && (ut.appendChildNodes(r, y.from(s.childNodes)), ut.remove(s)),
                        t
                    );
                }
                releaseList(t, e) {
                        ...
                        n.a.each(t, (t, i) => {
                            ...
                            if ('LI' === a.parentNode.nodeName)
                                i.map(t => {
                                    ...
                                    l.nextSibling ? l.parentNode.insertBefore(t, l.nextSibling) : l.parentNode.appendChild(t),
                                        e.length && (this.wrapList(e, a.nodeName), t.appendChild(e[0].parentNode));
                                }),
                                    0 === a.children.length && l.removeChild(a),
                                    0 === l.childNodes.length && l.parentNode.removeChild(l);
                            else {
                                const t =
                                        a.childNodes.length > 1
                                            ? ut.splitTree(
                                                  a,
                                                  { node: r.parentNode, offset: ut.position(r) + 1 },
                                                  { isSkipPaddingBlankHTML: !0 },
                                              )
                                            : null,
                                    o = ut.splitTree(a, { node: s.parentNode, offset: ut.position(s) }, { isSkipPaddingBlankHTML: !0 });
                                (i = e ? ut.listDescendant(o, ut.isLi) : y.from(o.childNodes).filter(ut.isLi)),
                                    (!e && ut.isList(a.parentNode)) || (i = i.map(t => ut.replace(t, 'P'))),
            ...
            class xt {
                ...
                insertParagraph(t, e) {
                    ...
                    let i;
                    if (o) {
                        if (ut.isLi(o) && (ut.isEmpty(o) || ut.deepestChildIsEmpty(o)))
                            return void this.bullet.toggleList(o.parentNode.nodeName);
                        {
                            ...
                            if (
                                (1 === this.options.blockquoteBreakingLevel
                                    ...
                                    : 2 === this.options.blockquoteBreakingLevel && (t = ut.lastAncestor(o, ut.isBlockquote)),
                                t)
                            ) {
                                (i = n()(ut.emptyPara)[0]),
                                    ut.isRightEdgePoint(e.getStartPoint()) && ut.isBR(e.sc.nextSibling) && n()(e.sc.nextSibling).remove();
                                ...
                                (t = t.concat(ut.listDescendant(i, ut.isEmptyAnchor))),
                                    n.a.each(t, (t, e) => {
                                        ut.remove(e);
                                    }),
            ...
            (St.where = { Row: 0, Column: 1 }),
                ...
                (St.resultAction = { Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4 });
            class $t {
                tab(t, e) {
                            ...
                            case St.resultAction.SumSpanCount:
                                if ('top' === e) {
                                    if ((o.baseCell.parent ? o.baseCell.closest('tr').rowIndex : 0) <= i[0].rowIndex) {
                                        const t = n()('<div></div>')
                                            .append(n()('<td' + s + '>' + ut.blank + '</td>').removeAttr('rowspan'))
                                            .html();
                                        r.append(t);
                                        break;
                                    }
                ...
                addCol(t, e) {
                    ...
                    for (let t = 0; t < s.length; t++) {
                        ...
                        switch (o.action) {
                            case St.resultAction.AddCell:
                                'right' === e
                                    ? n()(o.baseCell).after('<td' + i + '>' + ut.blank + '</td>')
                                    : n()(o.baseCell).before('<td' + i + '>' + ut.blank + '</td>');
                                break;
                            case St.resultAction.SumSpanCount:
                                if ('right' === e) {
                ...
                recoverAttributes(t) {
                    ...
                    for (let t = 0; t < o.length; t++)
                        'id' !== o[t].name.toLowerCase() && o[t].specified && (e += ' ' + o[t].name + "='" + o[t].value + "'");
                    return e;
                }
                deleteRow(t) {
                    ...
                    for (let t = 0; t < r.length; t++) {
                        ...
                        switch (r[t].action) {
                            ...
                            case St.resultAction.SubtractSpanCount:
                                a &&
                                    (l > 2
                                        ? (l--, e.setAttribute('rowSpan', l), n.rowIndex !== s && e.cellIndex === i && (e.innerHTML = ''))
                                        : 2 === l &&
                                          (e.removeAttribute('rowSpan'), n.rowIndex !== s && e.cellIndex === i && (e.innerHTML = '')));
                                continue;
                            ...
                            switch (s[t].action) {
                                ...
                                case St.resultAction.SubtractSpanCount:
                                    ...
                                    if (e.colSpan && e.colSpan > 1) {
                                        ...
                                        t > 2
                                            ? (t--, e.setAttribute('colSpan', t), e.cellIndex === i && (e.innerHTML = ''))
                                            : 2 === t && (e.removeAttribute('colSpan'), e.cellIndex === i && (e.innerHTML = ''));
                                    }
                                    continue;
                                case St.resultAction.RemoveCell:
                ...
                options: {
                    ...
                    modules: {
                        editor: class {
                            constructor(t) {
                                ...
                                for (let t = 0, o = e.length; t < o; t++)
                                    (this[e[t]] = (t => e => {
                                        ...
                                        this.context.memo('help.' + e[t], this.lang.help[e[t]]);
                                (this.fontName = this.wrapCommand(t => this.fontStyling('font-family', f.validFontName(t)))),
                                ...
                                for (let t = 1; t <= 6; t++)
                                    (this['formatH' + t] = (t => () => {
                                        ...
                                        this.context.memo('help.formatH' + t, this.lang.help['formatH' + t]);
                                (this.insertParagraph = this.wrapCommand(() => {
                                    ...
                                    (this.createLink = this.wrapCommand(t => {
                                        ...
                                        'string' == typeof e && (e = e.trim()),
                                            this.options.onCreateLink
                                                ? (e = this.options.onCreateLink(e))
                                                : s &&
                                                  (e = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(e) ? e : this.options.defaultProtocol + e);
                                        let c = [];
                                        if (l) {
                                            r = r.deleteContents();
                                    ...
                                    (this.insertTable = this.wrapCommand(t => {
                                        ...
                                        this.getLastRange()
                                            .deleteContents()
                                            .insertNode(this.table.createTable(e[0], e[1], this.options));
                                    })),
                                    (this.removeMedia = this.wrapCommand(() => {
                                        let t = n()(this.restoreTarget()).parent();
                                        t.closest('figure').length
                                            ? t.closest('figure').remove()
                                            : (t = n()(this.restoreTarget()).detach()),
                                            this.context.triggerEvent('media.delete', t, this.$editable);
                                    })),
                            ...
                            initialize() {
                                this.$editable
                                    .on('keydown', t => {
                                        if (
                                            (t.keyCode === kt.code.ENTER && this.context.triggerEvent('enter', t),
                                            this.context.triggerEvent('keydown', t),
                                            (this.snapshot = this.history.makeSnapshot()),
                                            t.isDefaultPrevented() ||
                                                (this.options.shortcuts ? this.handleKeyMap(t) : this.preventDefaultEditableShortCuts(t)),
                                            this.isLimited(1, t))
                                        ) {
                                    ...
                                    this.$editable.html(ut.html(this.$note) || ut.emptyPara),
                                    this.$editable.on(
                                        f.inputEventName,
                                        b.debounce(() => {
                            ...
                            handleKeyMap(t) {
                                ...
                                'TAB' !== i || this.options.tabDisable
                                    ? n
                                        ? !1 !== this.context.invoke(n) && t.preventDefault()
                                        : kt.isEdit(t.keyCode) && this.afterCommand()
                                    : this.afterCommand();
                            }
                                ...
                                return (
                                    ...
                                    (void 0 === e ||
                                        !(
                                            ...
                                            e.ctrlKey ||
                                            e.metaKey ||
                                            y.contains([kt.code.BACKSPACE, kt.code.DELETE], e.keyCode)
                                        )) &&
                            ...
                            setLastRange(t) {
                                t
                                    ...
                                    : ((this.lastRange = bt.create(this.editable)),
                                      0 === n()(this.lastRange.sc).closest('.note-editable').length &&
                                          (this.lastRange = bt.createFromBodyElement(this.editable)));
                            }
                            getLastRange() {
                                        ...
                                        this.beforeCommand(),
                                            'function' == typeof e
                                                ...
                                                : ('string' == typeof e && t.attr('data-filename', e),
                                                  t.css('width', Math.min(this.$editable.width(), t.width()))),
                                            t.show(),
                                            this.getLastRange().insertNode(t[0]),
                                            this.setLastRange(bt.createFromNodeAfter(t[0]).select()),
                                            this.afterCommand();
                                    })
                                    .fail(t => {
                            ...
                            insertImagesAsDataURL(t) {
                                n.a.each(t, (t, e) => {
                                    const o = e.name;
                                    this.options.maximumImageFileSize && this.options.maximumImageFileSize < e.size
                            ...
                            fontStyling(t, e) {
                                ...
                                if ('' !== o) {
                                    ...
                                    if ((this.$editor.find('.note-status-output').html(''), n()(i).css(t, e), o.isCollapsed())) {
                                        ...
                                        t &&
                                            !ut.nodeLength(t) &&
                                            ((t.innerHTML = ut.ZERO_WIDTH_NBSP_CHAR),
                                            bt.createFromNodeAfter(t.firstChild).select(),
                                            this.setLastRange(),
                            ...
                            getLinkInfo() {
                                const t = this.getLastRange().expand(ut.isAnchor),
                            ...
                            pasteByEvent(t) {
                                ...
                                if (e && e.items && e.items.length) {
                                    ...
                                    'file' === o.kind && -1 !== o.type.indexOf('image/')
                                        ...
                                        : 'string' === o.kind &&
                                          (this.context.invoke('editor.isLimited', e.getData('Text').length)
                                              ? t.preventDefault()
                                              : this.context.invoke('editor.afterCommand'));
                                }
                            }
                        ...
                        dropzone: class {
                            ...
                            initialize() {
                                this.options.disableDragAndDrop
                                    ? ((this.documentEventHandlers.onDrop = t => {
                                          t.preventDefault();
                                      }),
                            ...
                            attachDragAndDropEvent() {
                                ...
                                (this.documentEventHandlers.onDragenter = o => {
                                    ...
                                    (this.documentEventHandlers.onDragleave = e => {
                                        (t = t.not(e.target)),
                                            (t.length && 'BODY' !== e.target.nodeName) ||
                                        ...
                                        .on('drop', t => {
                                            ...
                                            t.preventDefault(),
                                                e && e.files && e.files.length
                                                    ? (this.$editable.focus(),
                                                      this.context.invoke('editor.insertImagesOrCallback', e.files))
                                                    : n.a.each(e.types, (t, o) => {
                                                          if (o.toLowerCase().indexOf('_moz_') > -1) return;
                                                          const i = e.getData(o);
                                                          o.toLowerCase().indexOf('text') > -1
                                                              ? this.context.invoke('editor.pasteHTML', i)
                                                              : n()(i).each((t, e) => {
                        ...
                        codeview: class {
                            ...
                            purify(t) {
                                if (
                                    ...
                                    ((t = t.replace(this.options.codeviewFilterRegex, '')), this.options.codeviewIframeFilter)
                                ) {
                            ...
                            activate() {
                                if (
                                    (this.$codable.val(ut.html(this.$editable, this.options.prettifyHtml)),
                                    ...
                                    t.on('blur', e => {
                                        ...
                                        t.setSize(null, this.$editable.outerHeight()),
                                    ...
                                    : this.$statusbar.on('mousedown', t => {
                                          ...
                                          const e = this.$editable.offset().top - this.$document.scrollTop(),
                                              o = t => {
                                                  ...
                                                  (o = this.options.minheight > 0 ? Math.max(o, this.options.minheight) : o),
                                                      (o = this.options.maxHeight > 0 ? Math.min(o, this.options.maxHeight) : o),
                                        ...
                                        if (ut.isControlSizing(t.target)) {
                                            ...
                                            const e = this.$handle.find('.note-control-selection').data('target'),
                                                ...
                                                n = t => {
                                                    this.context.invoke(
                                                        'editor.resizeTo',
                                                        { x: t.clientX - o.left, y: t.clientY - (o.top - i) },
                                                        e,
                                                        !t.shiftKey,
                                                    ),
                                                        this.update(e[0], t);
                        ...
                        hintPopover: class {
                            ...
                            initialize() {
                                (this.lastWordRange = null),
                                    ...
                                    this.$content.on('click', '.note-hint-item', t => {
                            ...
                            moveDown() {
                                ...
                                if (e.length) this.selectItem(e);
                                    ...
                                    let e = t.parent().next();
                                    e.length || (e = this.$content.find('.note-hint-group').first()),
                            ...
                            moveUp() {
                                ...
                                if (e.length) this.selectItem(e);
                                    ...
                                    let e = t.parent().prev();
                                    e.length || (e = this.$content.find('.note-hint-group').last()),
                            ...
                            handleKeydown(t) {
                                this.$popover.is(':visible') &&
                                    (t.keyCode === kt.code.ENTER
                                        ...
                                        : t.keyCode === kt.code.DOWN && (t.preventDefault(), this.moveDown()));
                            }
                            searchKeyword(t, e, o) {
                            ...
                            handleKeyup(t) {
                                if (!y.contains([kt.code.ENTER, kt.code.UP, kt.code.DOWN], t.keyCode)) {
                                    let t,
                                        e,
                                        o = this.context.invoke('editor.getLastRange');
                                    ...
                                    if (this.hints.length && e) {
                                        this.$content.empty();
                                        const o = b.rect2bnd(y.last(t.getClientRects())),
                                            i = n()(this.options.container).offset();
                                        o &&
                                            ((o.top -= i.top),
                                            (o.left -= i.left),
                                            this.$popover.hide(),
                                            ...
                                            'top' === this.direction
                                                ? this.$popover.css({ left: o.left, top: o.top - this.$popover.outerHeight() - 5 })
                                ...
                                if (e && (e[1] || e[2])) {
                                    const o = e[1] ? t : 'http://' + t,
                                        ...
                                        s = n()('<a />')
                                            .html(i)
                                            .attr('href', o)[0];
                                    this.context.options.linkTargetBlank && n()(s).attr('target', '_blank'),
                        ...
                        placeholder: class {
                            ...
                            initialize() {
                                (this.$placeholder = n()('<div class="note-placeholder">')),
                                    this.$placeholder
                                        .on('click', () => {
                        ...
                        buttons: class {
                            constructor(t) {
                                (this.ui = n.a.summernote.ui),
                                    ...
                                    (this.options = t.options),
                                    (this.lang = this.options.langInfo),
                                    (this.invertedKeyMap = b.invertObject(this.options.keyMap[f.isMac ? 'mac' : 'pc']));
                            }
                            representShortcut(t) {
                                            ...
                                            this.button({
                                                ...
                                                click: t => {
                                                    ...
                                                    o && i
                                                        ...
                                                        : o
                                                        ? this.context.invoke('editor.color', { backColor: e.attr('data-backColor') })
                                                        : i && this.context.invoke('editor.color', { foreColor: e.attr('data-foreColor') });
                                                },
                                                callback: t => {
                                                    const e = t.find('.note-recent-color');
                                                    o &&
                                                        (e.css('background-color', this.options.colorButton.backColor),
                                                        t.attr('data-backColor', this.options.colorButton.backColor)),
                                                        i
                                                            ? (e.css('color', this.options.colorButton.foreColor),
                                                              t.attr('data-foreColor', this.options.colorButton.foreColor))
                            ...
                            addToolbarButtons() {
                                    ...
                                    this.ui
                                        .buttonGroup([
                                            ...
                                            this.ui.dropdown({
                                                ...
                                                template: t => {
                                                    'string' == typeof t &&
                                                        (t = { tag: t, title: this.lang.style.hasOwnProperty(t) ? this.lang.style[t] : t });
                                                    const e = t.tag,
                                                        o = t.title;
                                                    return (
                                                        '<' +
                                ...
                                this.context.memo('button.bold', () =>
                                    ...
                                    this.context.memo('button.fontname', () => {
                                        ...
                                        return (
                                            this.options.addDefaultFonts &&
                                                n.a.each(t['font-family'].split(','), (t, e) => {
                                                    (e = e.trim().replace(/['"]+/g, '')),
                                                        this.isFontDeservedToAdd(e) &&
                                                            -1 === this.options.fontNames.indexOf(e) &&
                                                            this.options.fontNames.push(e);
                                                }),
                                            this.ui
                                                .buttonGroup([
                                                    this.button({
                                                    ...
                                                    this.ui.dropdownCheck({
                                                        ...
                                                        template: t =>
                                                            '<span style="font-family: ' + f.validFontName(t) + '">' + t + '</span>',
                                    ...
                                    this.context.memo('button.color', () =>
                                        this.colorPalette('note-color-all', this.lang.color.recent, !0, !0),
                                    ),
                                    this.context.memo('button.forecolor', () =>
                                        this.colorPalette('note-color-fore', this.lang.color.foreground, !1, !0),
                                    ),
                                    this.context.memo('button.backcolor', () =>
                                        this.colorPalette('note-color-back', this.lang.color.background, !0, !1),
                                    ),
                                ...
                                this.context.memo('button.justifyLeft', b.invoke(t, 'render')),
                                    this.context.memo('button.justifyCenter', b.invoke(e, 'render')),
                                    this.context.memo('button.justifyRight', b.invoke(o, 'render')),
                                    this.context.memo('button.justifyFull', b.invoke(i, 'render')),
                                    this.context.memo('button.outdent', b.invoke(s, 'render')),
                                    this.context.memo('button.indent', b.invoke(r, 'render')),
                                    this.context.memo('button.paragraph', () =>
                                        this.ui
                                            .buttonGroup([
                                                ...
                                                this.ui.dropdown([
                                                    this.ui.buttonGroup({ className: 'note-align', children: [t, e, o, i] }),
                                                    this.ui.buttonGroup({ className: 'note-list', children: [s, r] }),
                                                ]),
                                            ])
                                            .render(),
                                    ),
                            ...
                            updateCurrentStyle(t) {
                                ...
                                if (
                                    ...
                                    const t = o['font-family'].split(',').map(t =>
                                            t
                                                .replace(/[\'\"]/g, '')
                                                .replace(/\s+$/, '')
                                                .replace(/^\s+/, ''),
                            ...
                            tableMoveHandler(t) {
                                ...
                                s.css({ width: l + 'em', height: c + 'em' }),
                                    i.data('value', l + 'x' + c),
                                    l > 3 && l < this.options.insertTableMaxSize.col && r.css({ width: l + 1 + 'em' }),
                                    c > 3 && c < this.options.insertTableMaxSize.row && r.css({ height: c + 1 + 'em' }),
                                    o.html(l + ' x ' + c);
                            }
                        },
                        toolbar: class {
                            ...
                            followScroll() {
                                ...
                                !this.isFollowing && r > l && r < c - o
                                    ? ((this.isFollowing = !0),
                                      this.$toolbar.css({ position: 'fixed', top: s, width: e, zIndex: 1e3 }),
                            ...
                            update() {
                                ...
                                if (t.isCollapsed() && t.isOnAnchor()) {
                                    ...
                                    const i = ut.posFromPlaceholder(e),
                                        s = n()(this.options.container).offset();
                        ...
                        imageDialog: class {
                            ...
                            initialize() {
                                ...
                                this.$dialog = this.ui
                                    .dialog({ title: this.lang.image.insert, fade: this.options.dialogsFade, body: o, footer: i })
                                    .render()
                                    .appendTo(e);
                            }
                            destroy() {
                                            ...
                                            this.ui.hideDialog(this.$dialog),
                                                ...
                                                'string' == typeof t
                                                    ? this.options.callbacks.onImageLinkInsert
                                                        ? this.context.triggerEvent('image.link.insert', t)
                                                        : this.context.invoke('editor.insertImage', t)
                                                    : this.context.invoke('editor.insertImagesOrCallback', t);
                                        })
                                        .fail(() => {
                                            this.context.invoke('editor.restoreRange');
                                        });
                            ...
                            update(t, e) {
                                if (ut.isImg(t)) {
                                    const o = n()(t).offset(),
                                        i = n()(this.options.container).offset();
                                    let s = {};
                                    this.options.popatmouse ? ((s.left = e.pageX - 20), (s.top = e.pageY)) : (s = o),
                                        (s.top -= i.top),
                                        (s.left -= i.left),
                                        this.$popover.css({ display: 'block', left: s.left, top: s.top });
                                } else this.hide();
                            }
                            hide() {
                                this.$popover.hide();
                            ...
                            update(t) {
                                ...
                                if (e) {
                                    const e = ut.posFromPlaceholder(t),
                                        o = n()(this.options.container).offset();
                            ...
                            createVideoNode(t) {
                                ...
                                if (o && 11 === o[1].length) {
                                    ...
                                    if (void 0 !== o[2]) {
                                        const t = o[2].match(e);
                                        if (t)
                                            for (var b = [3600, 60, 1], v = 0, k = b.length; v < k; v++)
                                                g += void 0 !== t[v + 1] ? b[v] * parseInt(t[v + 1], 10) : 0;
                                    }
                                    f = n()('<iframe>')
                                        .attr('frameborder', 0)
                                        .attr('src', '//www.youtube.com/embed/' + t + (g > 0 ? '?start=' + g : ''))
                                        .attr('width', '640')
                                        .attr('height', '360');
                                    ...
                                    f = n()('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                                        .attr('frameborder', 0)
                                    ...
                                    f = n()('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                                        ...
                                        .attr('height', '310')
                                        .attr('width', '500')
                                        .attr('src', 'https://v.qq.com/iframe/player.html?vid=' + t + '&amp;auto=0');
                                } else if (d || u || p)
                                    f = n()('<video controls>')
                                        .attr('src', t)
                                        .attr('width', '640')
                                ...
                                return n.a.Deferred(t => {
                                    ...
                                    this.ui.onDialogShown(this.$dialog, () => {
                                        this.context.triggerEvent('dialog.shown'),
                                            ...
                                            f.isSupportTouch || e.trigger('focus'),
                                            o.click(o => {
                            ...
                            createShortcutList() {
                                ...
                                return Object.keys(t)
                                    .map(e => {
                                        ...
                                        return (
                                            i
                                                .append(n()('<label><kbd>' + e + '</kdb></label>').css({ width: 180, 'margin-right': 10 }))
                                                .append(n()('<span/>').html(this.context.memo('help.' + o) || o)),
                                            i.html()
                                        );
                                    })
                                    .join('');
        ...
        52: function(t, e, o) {
            ...
            const r = s.a.create('<div class="note-editor note-frame card"/>'),
                        ...
                        ? e.items
                              .map(function(t) {
                                  ...
                                  return (
                                      ...
                                      ('data-value="' + o + '"' + (void 0 !== n ? ' data-option="' + n + '"' : '')) +
                ...
                b = s.a.create('<div class="note-dropdown-menu dropdown-menu note-check" role="list">', function(t, e) {
                    const o = Array.isArray(e.items)
                        ? e.items
                              .map(function(t) {
                                  const o = 'string' == typeof t ? t : t.value || '',
            ...
            var y = function(t) {
                return {
                    ...
                    button: function(e, o) {
                        return s.a.create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1">', function(e, o) {
                            o &&
                                o.tooltip &&
                                e
            ...
            o(3), o(5);
            (n.a.summernote = n.a.extend(n.a.summernote, { ui_template: y, interface: 'bs4' })),
