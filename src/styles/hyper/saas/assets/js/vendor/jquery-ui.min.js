        ...
        e.widget('ui.menu', {
            ...
            blur: function(e, t) {
                t || clearTimeout(this.timer),
                    this.active &&
                        (this.active.removeClass('ui-state-focus'), (this.active = null), this._trigger('blur', e, { item: this.active }));
            },
                ...
                o !== r && 'HTML' !== o.tagName
                    ? ((n.axis && 'x' === n.axis) ||
                          (s.overflowOffset.top + o.offsetHeight - t.pageY < n.scrollSensitivity
                              ...
                              : t.pageY - s.overflowOffset.top < n.scrollSensitivity && (o.scrollTop = a = o.scrollTop - n.scrollSpeed)),
                      (n.axis && 'y' === n.axis) ||
                          (s.overflowOffset.left + o.offsetWidth - t.pageX < n.scrollSensitivity
                              ? (o.scrollLeft = a = o.scrollLeft + n.scrollSpeed)
                              : t.pageX - s.overflowOffset.left < n.scrollSensitivity && (o.scrollLeft = a = o.scrollLeft - n.scrollSpeed)))
                    : ((n.axis && 'x' === n.axis) ||
                    ...
                    (h = s.snapElements[c].left - s.margins.left),
                        ...
                        !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item)
                            ? (s.snapElements[c].snapping &&
                                  ...
                                  s.options.snap.release.call(s.element, t, e.extend(s._uiHash(), { snapItem: s.snapElements[c].item })),
            ...
            resize: function(t) {
                ...
                c[0] !== document && /static/.test(c.css('position')) && (d = h),
                    ...
                    s + o.size.height >= o.parentData.height &&
                        ((o.size.height = o.parentData.height - s), u && ((o.size.width = o.size.height * o.aspectRatio), (p = !1))),
                    p ||
    ...
    (e.effects = { effect: {} }),
        ...
        (e.effects.effect.puff = function(t, i) {
            ...
            e.extend(t, {
                ...
                complete: i,
                percent: a ? o : 100,
                from: a ? h : { height: h.height * r, width: h.width * r, outerHeight: h.outerHeight * r, outerWidth: h.outerWidth * r },
            }),
                s.effect(t);
        }),
        ...
        e.widget('ui.selectmenu', {
            ...
            _setSelection: function() {
                var e;
                this.range &&
                    (window.getSelection ? ((e = window.getSelection()), e.removeAllRanges(), e.addRange(this.range)) : this.range.select(),
                    this.button.focus());
            },
            _documentClick: {
                mousedown: function(t) {
        ...
        e.widget('ui.slider', e.ui.mouse, {
            ...
            _createHandles: function() {
                var t,
                    ...
                    o = [];
                for (
                    i = (s.values && s.values.length) || 1, n.length > i && (n.slice(i).remove(), (n = n.slice(0, i))), t = n.length;
                    i > t;
                    t++
                )
                    o.push(a);
        ...
        e.widget('ui.sortable', e.ui.mouse, {
            ...
            _rearrange: function(e, t, i, s) {
                i
                    ...
                    : t.item[0].parentNode.insertBefore(this.placeholder[0], 'down' === this.direction ? t.item[0] : t.item[0].nextSibling),
        ...
        e.widget('ui.spinner', {
            ...
            _events: {
                ...
                blur: function(e) {
                    return this.cancelBlur
                        ? (delete this.cancelBlur, void 0)
                        : (this._stop(), this._refresh(), this.previous !== this.element.val() && this._trigger('change', e), void 0);
                },
        ...
        e.widget('ui.tabs', {
            ...
            _setOption: function(e, t) {
                return 'active' === e
                    ...
                    : (this._super(e, t),
                      'collapsible' === e &&
                          (this.element.toggleClass('ui-tabs-collapsible', t), t || this.options.active !== !1 || this._activate(0)),
