        ...
        getValue: function(e) {
            ...
            return (
                i == this.scale.length - 1
                    ...
                    : (e = this.vectorToNum(
                          this.vectorAdd(this.scale[i], this.vectorMult(this.vectorSubtract(this.scale[i + 1], this.scale[i]), e / t[i])),
                      )),
                e
            );
        },
                    ...
                    if (!t) {
                        ...
                        if ((s === 'region' && e.params.regionsSelectable) || (s === 'marker' && e.params.markersSelectable))
                            u.isDefaultPrevented() ||
                                (e.params[s + 'sSelectableOne'] && e.clearSelected(s + 's'), a.setSelected(!a.isSelected));
                    }
                });
        },
