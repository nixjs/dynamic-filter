    ...
    (function(factory) {
        ...
        $.fn.sparkline.pie = pie = createClass($.fn.sparkline._base, {
            ...
            render: function() {
                ...
                if (donutWidth) {
                    target
                        .drawCircle(radius, radius, radius - donutWidth, options.get('donutColor'), options.get('donutColor'), 0)
                        .append();
                }
                target.render();
            },
        ...
        VCanvas_vml = createClass(VCanvas_base, {
            ...
            _drawShape: function(shapeid, path, lineColor, fillColor, lineWidth) {
                ...
                stroke =
                    lineColor === undefined ? ' stroked="false" ' : ' strokeWeight="' + lineWidth + 'px" strokeColor="' + lineColor + '" ';
