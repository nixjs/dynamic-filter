...
!(function(t, e) {
    ...
    var st = $.extend({
            ...
            inRange: function(t, e) {
                ...
                if (n) {
                    for (
                        var i = H.getAngleFromPoint(n, { x: t, y: e }), a = i.angle, r = i.distance, o = n.startAngle, s = n.endAngle;
                        s < o;
    ...
    H.extend(tn.prototype, {
        construct: function(t, e) {
            ...
            e = (function(t) {
                ...
                return (
                    (e.datasets = e.datasets || []), (e.labels = e.labels || []), (t.options = $e(W.global, W[t.type], t.options || {})), t
                );
            })(e);
        ...
        gi = e(function(e, n) {
            e.exports = (function() {
                ...
                function A(t, e) {
                    ...
                    for (n in e)
                        h(e, n) &&
                            (o(t[n]) && o(e[n]) ? ((i[n] = {}), c(i[n], t[n]), c(i[n], e[n])) : null != e[n] ? (i[n] = e[n]) : delete i[n]);
                ...
                function an(t, e) {
                    ...
                    return (
                        -(
                            n +
                            (e - i < 0 ? (e - i) / (i - t.clone().add(n - 1, 'months')) : (e - i) / (t.clone().add(n + 1, 'months') - i))
                        ) || 0
                    );
                }
                function rn(t) {
