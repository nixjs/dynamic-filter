...
(dataColors = $('#basic-scatter').data('colors')) && (colors = dataColors.split(','));
var options = {
...
(chart = new ApexCharts(document.querySelector('#basic-scatter'), options)).render();
...
options = {
    ...
    fill: {
        type: 'image',
        opacity: 1,
        image: { src: ['assets/images/ico-messenger.png', 'assets/images/ico-instagram.png'], width: 40, height: 40 },
    },
    legend: {
