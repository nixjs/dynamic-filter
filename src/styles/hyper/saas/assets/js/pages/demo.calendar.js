    ...
    (e.prototype.onDrop = function(e, t) {
        ...
        (e.prototype.onSelect = function(n, a, e) {
            ...
            i.append("<div class='row'></div>"),
                ...
                l.$modal.find('form').on('submit', function() {
                    ...
                    return (
                        null !== e && 0 != e.length
                            ? (l.$calendarObj.fullCalendar('renderEvent', { title: e, start: n, end: a, allDay: !1, className: t }, !0),
                              l.$modal.modal('hide'))
        ...
        (e.prototype.init = function() {
            ...
            var e = new Date(),
                ...
                n = [
                    { title: 'Hey!', start: new Date(o.now() + 158e6), className: 'bg-warning' },
                    { title: 'See John Deo', start: t, end: t, className: 'bg-success' },
                    { title: 'Meet John Deo', start: new Date(o.now() + 168e6), className: 'bg-info' },
                    { title: 'Buy a Theme', start: new Date(o.now() + 338e6), className: 'bg-primary' },
                ],
                a = this;
