...
var randomizeArray = function(e) {
    for (var r, t, a = e.slice(), o = a.length; 0 !== o; )
        (t = Math.floor(Math.random() * o)), (r = a[(o -= 1)]), (a[o] = a[t]), (a[t] = r);
    return a;
};
$(document).ready(function() {
    'use strict';
    for (
        var e = [47, 45, 54, 38, 56, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46], r = [], t = 1;
        t <= 24;
        t++
    )
        r.push('2018-09-' + t);
    ...
    new ApexCharts(document.querySelector('#spark1'), l).render(),
        new ApexCharts(document.querySelector('#spark2'), i).render(),
