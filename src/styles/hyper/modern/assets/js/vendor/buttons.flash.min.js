(function(g) {
    ...
    h.Client.prototype = {
        ...
        glue: function(a, b) {
            ...
            this.domElement &&
                (this.domElement.appendChild(this.div), (this.div.innerHTML = this.getHTML(c.width, c.height).replace(/&/g, '&amp;')));
        },
        ...
        action: function(a, b, d, c) {
            if (c._fromFlash) {
                ...
                b.buttons.info(
                    ...
                    b.i18n('buttons.copySuccess', { _: 'Copied %d rows to clipboard', 1: 'Copied 1 row to clipboard' }, data.rows),
                    3e3,
                );
            }
        },
                    ...
                    for (var b = 0, d = a.length; b < d; b++) {
                        ...
                        i ||
                            ('number' === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                                ...
                                : ((n = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')),
                                  (i = o(f, 'c', {
