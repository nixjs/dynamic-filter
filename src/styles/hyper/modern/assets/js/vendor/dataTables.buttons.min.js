...
(function(d) {
    ...
    d.extend(m.prototype, {
        ...
        remove: function(a) {
            var b = this._nodeToButton(a),
                ...
                e = this.s.dt;
            if (b.buttons.length) for (var i = b.buttons.length - 1; 0 <= i; i--) this.remove(b.buttons[i].node);
        ...
        _buildButton: function(a, b) {
            ...
            return { conf: a, node: h.get(0), inserter: e, buttons: [], inCollection: b, collection: null };
        },
                ...
                i = function(a, b) {
                    ...
                    if (d.isArray(a) || a instanceof d) {
                        ...
                        if (-1 !== a.indexOf(',')) {
                            ...
                            h = 0;
                            for (g = f.length; h < g; h++) f[h].name === j && c.push({ inst: b, node: f[h].node });
                        } else
                            d(h)
                                .filter(a)
                                .each(function() {
    ...
    m.defaults = {
        ...
        dom: {
            ...
            button: { tag: 'ActiveXObject' in p ? 'a' : 'button', className: 'dt-button', active: 'active', disabled: 'disabled' },
                ...
                if (!a) {
                    ...
                    k && 'absolute' === g
                        ...
                        ? (e._collection.css({ top: a.top + c.outerHeight(), left: a.left }),
                          ...
                          (g = f.offset().top - g),
                          (k > g || e.dropup) && e._collection.css('top', a.top - e._collection.outerHeight() - 5),
                          e._collection.hasClass(e.rightAlignClassName) &&
                              e._collection.css('left', a.left + c.outerWidth() - e._collection.outerWidth()),
    ...
    j.Api.registerPlural('buttons().containers()', 'buttons().container()', function() {
        ...
        this.iterator(!0, 'table', function(c) {
            if (c._buttons) for (var c = m.instanceSelector(b, c._buttons), d = 0, i = c.length; d < i; d++) a = a.add(c[d].container());
        });
        return a;
    });
    ...
    j.Api.register('buttons.exportInfo()', function(a) {
        ...
        b === n || null === b
            ? (b = null)
            : (-1 !== b.indexOf('*') && (b = d.trim(b.replace('*', d('head > title').text()))),
