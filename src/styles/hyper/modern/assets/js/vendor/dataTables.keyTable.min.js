    ...
    f.extend(n.prototype, {
                    ...
                    if (d && (!e || 'body' === e.nodeName.toLowerCase()))
                        c.preventDefault(),
                            k.clipboardData && k.clipboardData.getData
                                ...
                                : c.clipboardData && c.clipboardData.getData && (g = c.clipboardData.getData('text/plain')),
                            f
                                ? f
                                      .inline(d.cell.index())
                                      .set(f.displayed()[0], g)
        ...
        _editor: function(a, b, c) {
            ...
            if (
                ...
                !(
                    null !== a &&
                    ((0 <= a && 9 >= a) || 11 === a || 12 === a || (14 <= a && 31 >= a) || (112 <= a && 123 >= a) || (127 <= a && 159 >= a))
                )
            ) {
                b.stopPropagation();
                ...
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length))
                    ...
                    if (c === o || !0 === c)
                        this._scroll(f(k), f(h.body), i, 'offset'),
                            ...
                            c !== j.table().header().parentNode && ((c = f(c.parentNode)), this._scroll(c, c, i, 'position'));
                    this.s.lastFocus = {
                        cell: g,
                        node: g.node(),
                        relative: {
