var colors = ['#fa6767'];
(dataColors = $('#basic-area').data('colors')) && (colors = dataColors.split(','));
var options = {
...
options = {
    ...
    legend: { offsetY: -10 },
    grid: { yaxis: { lines: { offsetX: -30 } }, padding: { left: 0 }, borderColor: '#f1f3fa' },
};
...
options = {
    ...
    stroke: { width: 3 },
    fill: {
        gradient: { enabled: !0, shadeIntensity: 1, inverseColors: !1, opacityFrom: 0.45, opacityTo: 0.05, stops: [20, 100, 100, 100] },
    },
    yaxis: {
        labels: {
            style: { color: '#8e8da4' },
...
options = {
    ...
    fill: {
        opacity: 0.8,
        gradient: { enabled: !1 },
        pattern: { enabled: !0, style: ['verticalLines', 'horizontalLines'], width: 5, depth: 6 },
    },
